...
public class FacultyModelTest {
	...
	public static void searchTest() throws ApplicationException {
		...
		for (FacultyDTO dto : a) {
			System.out.println(dto.getId() + "\t" + dto.getFirstName() + "\t" + dto.getLastName() + "\t"
					+ dto.getGender() + "\t" + dto.getDob() + "\t" + dto.getQualification() + "\t" + dto.getMobileNo()
	...
	public static void updateTest()
			throws ParseException, ApplicationException, DatabaseException, DuplicateRecordException {
		// TODO Auto-generated method stub
		FacultyDTO dto = new FacultyDTO();
	...
	public static void findByPKTest() throws ApplicationException {
		...
		System.out.println(dto.getId() + "\t" + dto.getFirstName() + "\t" + dto.getLastName() + "\t" + dto.getGender()
				+ "\t" + dto.getDob() + "\t" + dto.getQualification() + "\t" + dto.getMobileNo() + "\t"
